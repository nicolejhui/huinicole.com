export default {
  ...
  body: [
    { heading: "What is the goal of SikFan:" },
    ...
    { figure: "tir-comparison" },

    { heading: "Defining the User Experience:" },
    { subheading: "Who is the user?" },
    { note: "Me, duh! If you want to read why I'm building this, check out ", linkText: "my intro article", linkSlug: "sikfan-lets-eat", after: "!" },
    ...
    { numbered: [
      ...
      "The general glycemic index of the ingredients in the dish, which determines how fast glucose is absorbed by the bloodstream",
      "How far in advance should the insulin be taken prior to the meal (Pre-bolusing)*"
    ] },
    ...
    { subheading: "Blood glucose at time of eating meal:" },
    ...
    { labels: [
      { label: "X", def: "inputs = factors that affect my blood glucose post meal (assuming a standard insulin dosage and no pre-bolus)" },
      { label: "Y", def: "output = my blood glucose 2 hours after a meal" }
    ] },
    "So instead of displaying the raw numerical prediction, I decided to create UI labels based on numeric ranges:",
    { labels: [
      { label: "SPIKE", def: "If 2 hours post-meal glucose is 40+ mg/dL greater than mealtime glucose" },
      { label: "DROP", def: "If 2 hours post-meal glucose is less than 20 mg/dL than mealtime glucose" },
      { label: "STEADY", def: "If 2 hours post-meal glucose is within the range of \"drop\" and \"spike\" compared to mealtime glucose" }
    ] },
    ...
    { heading: "How will the user get the information needed to inform their insulin dosage" },
    ...
    { subheading: "Cool, I'm happy with the prediction, now what happens?" },
